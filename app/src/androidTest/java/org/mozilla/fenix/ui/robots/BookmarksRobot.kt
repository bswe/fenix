...
private fun assertBookmarkFolderSelector() = onView(withId(R.id.bookmarkFolderSelector)).check(matches(withEffectiveVisibility(ViewMatchers.Visibility.VISIBLE)))
